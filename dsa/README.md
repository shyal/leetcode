...
- `sql.py` - query idioms
- `maxheapq.py` - heapq with the order reversed; the harness preloads `maxheappush`, `maxheappop`, `maxheapify`, `maxheappushpop`, `maxheapreplace`, `maxheappeek`, `maxheapitems`
