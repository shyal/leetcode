...
UTC (utils/solved), so between 16:00 and 24:00 UTC — midnight to 8am Manila,
...
import kg_lib
from kg_lib import MANILA, manila_date_from_filename, due_drill, last_drilled
...
solved = SourceFileLoader("solved_cli", os.path.join(UTILS, "solved")).load_module()
...
# --- utils/solved stamps in UTC and the round trip lands on the Manila day -----
