...
class str(Sequence[str]):
    ...
    @overload
    def __getitem__(
        self: LiteralString, key: SupportsIndex | slice, /
    ) -> LiteralString: ...
    @overload
...
# A Counter that drops a key when its count reaches 0
class Multiset(_Counter[T]): ...
...
# Function stubs for dsa.maxheapq (heapq with the order reversed)
def maxheapify(heap: List[T]) -> None: ...
def maxheappop(heap: List[T]) -> T: ...
def maxheappush(heap: List[T], item: T) -> None: ...
def maxheappushpop(heap: List[T], item: T) -> T: ...
def maxheapreplace(heap: List[T], item: T) -> T: ...
def maxheappeek(heap: List[T]) -> T: ...
def maxheapitems(heap: List[T]) -> List[T]: ...

# Function stubs for grid_utils (grid helpers preloaded by the harness)
...
# Function stubs for assert_utils (comparisons preloaded by the harness)
...
def folds(cls: type, op: str, start: bool = False, where: bool = False, block: bool = False) -> bool: ...

# Function stubs for combo_utils (index combinations preloaded by the harness)
def as_list(f: Callable[..., Iterator[T]]) -> Callable[..., List[T]]: ...
def pairs(n: int, type: Callable[[Iterable[int]], Any] = ...) -> Iterator[Any]: ...
def triples(n: int, type: Callable[[Iterable[int]], Any] = ...) -> Iterator[Any]: ...
...
def build_general_tree(nested: List[Any]) -> Node: ...
def get_general_tree(root: Optional[Node]) -> Optional[List[Any]]: ...
...
def dropwhile(*args: Any, **kwargs: Any) -> Any: ...
def cache(*args: Any, **kwargs: Any) -> Any: ...
def gcd(a: int, b: int) -> Any: ...
def isclose(a: int, b: int) -> Any: ...
def ceil_div(a: int, b: int) -> int: ...
def run_with_input(input: str, main: Callable) -> Any: ...
def build_nary_tree(arr: list) -> Any: ...
