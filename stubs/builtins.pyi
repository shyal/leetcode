...
class defaultdict(dict, Generic[_KT, _VT]):
    def __init__(
        self, default_factory: Optional[Callable[[], _VT]] = None, /, **kwargs: _VT
    ) -> None: ...
...
class Counter(dict, Generic[_T]):
    def __init__(
        self, iterable: Optional[Iterable[_T]] = None, /, **kwds: int
    ) -> None: ...
    def elements(self) -> Iterator[_T]: ...
    def most_common(self, n: Optional[int] = None) -> List[Tuple[_T, int]]: ...
    @classmethod
    def fromkeys(
        cls, iterable: Iterable[_T], v: Optional[int] = None
    ) -> "Counter[_T]": ...
    def update(
        self, iterable: Optional[Iterable[_T]] = None, /, **kwds: int
    ) -> None: ...
...
def reduce(
    function: Callable[[Any, Any], Any], sequence: Iterable[Any], initial: Any = ...
) -> Any: ...
def takewhile(
    predicate: Callable[[Any], bool], iterable: Iterable[Any]
) -> Iterator[Any]: ...
def product(
    *iterables: Iterable[Any], repeat: int = 1
) -> Iterator[Tuple[Any, ...]]: ...
...
def bisect_right(
    a: List[Any], x: Any, lo: int = 0, hi: Optional[int] = None
) -> int: ...
...
def nlargest(
    n: int, iterable: Iterable[Any], key: Optional[Callable[[Any], Any]] = None
) -> List[Any]: ...
def nsmallest(
    n: int, iterable: Iterable[Any], key: Optional[Callable[[Any], Any]] = None
) -> List[Any]: ...
...
def permutations(
    iterable: Iterable[Any], r: Optional[int] = None
) -> Iterator[Tuple[Any, ...]]: ...
...
def tabulate(
    tabular_data: Any, headers: Any = ..., tablefmt: str = ..., **kwargs: Any
) -> str: ...
