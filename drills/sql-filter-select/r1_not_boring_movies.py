...
print(run(EXAMPLE_1, sol.query()))  # [(5, 'House card', 'Interesting', 9.1), (1, 'War', 'great 3D', 8.9)]

# assert run(EXAMPLE_1, sol.query()) == [(5, 'House card', 'Interesting', 9.1), (1, 'War', 'great 3D', 8.9)]
# assert run(EXAMPLE_2, sol.query()) == []
