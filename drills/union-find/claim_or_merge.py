...
print(claim(sol, [[41, 42], [43], [42, 44], [45, 43]]))  # ({41: 0, 42: 0, 43: 1, 44: 2, 45: 3}, [[0, 2], [1, 3]])

# assert claim(Solution(4), [[41, 42], [43], [42, 44], [45, 43]]) == ({41: 0, 42: 0, 43: 1, 44: 2, 45: 3}, [[0, 2], [1, 3]])
# assert claim(Solution(3), [[47], [47], [47]]) == ({47: 0}, [[0, 1, 2]])
# assert claim(Solution(1), [[48]]) == ({48: 0}, [[0]])
# assert claim(Solution(2), [[41, 42], [43, 44]]) == ({41: 0, 42: 0, 43: 1, 44: 1}, [[0], [1]])
# assert claim(Solution(3), [[41, 42], [43, 44], [42, 43]]) == ({41: 0, 42: 0, 43: 1, 44: 1}, [[0, 1, 2]])
