...
print(sol.both(Color.red | Color.blue, Color.blue | Color.green, ["blue", "red", "green"]))  # ['blue']

# assert sol.both(Color.red | Color.blue, Color.blue | Color.green, ["blue", "red", "green"]) == ["blue"]
# assert sol.both(Color.red | Color.green, Color.blue, ["red", "green"]) == []
# assert sol.both(Color.green, Color.green | Color.red, ["green", "red", "green"]) == ["green", "green"]
# assert sol.both(Color.red | Color.green | Color.blue, Color.red | Color.green | Color.blue, ["blue", "red", "green"]) == ["blue", "red", "green"]
# assert sol.both(Color.red | Color.blue, Color.red | Color.blue, ["green", "green", "blue", "green", "green"]) == ["blue"]
# assert sol.both(Color.blue, Color.blue | Color.green, ["green", "red", "green", "blue"]) == ["blue"]
# assert sol.both(Color(0), Color.red | Color.green | Color.blue, ["red", "green", "blue"]) == []
# assert sol.both(Color.red, Color.red, []) == []
# assert sol.both(Color.red | Color.green, Color.green | Color.blue, ["red"] * 999 + ["green"]) == ["green"]
