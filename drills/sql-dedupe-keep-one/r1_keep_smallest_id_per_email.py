...
print(run(EXAMPLE_1, sol.query()))  # [(1, 'john@example.com'), (2, 'bob@example.com')]

# assert run(EXAMPLE_1, sol.query()) == [(1, 'john@example.com'), (2, 'bob@example.com')]
# assert run(EXAMPLE_2, sol.query()) == [(4, 'a@x.com')]
