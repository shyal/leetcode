...
sol = Solution()
print(sol.either(Color.red, Color.blue, ['blue', 'green', 'red']))
assert sol.either(Color.red, Color.blue, ['blue', 'green', 'red']) == ['blue', 'red']
assert sol.either(Color(0), Color(0), ['red', 'green']) == []
assert sol.either(Color.green, Color.green, ['green', 'red', 'green']) == ['green', 'green']
assert sol.either(Color.red | Color.green, Color.blue, ['blue', 'red', 'green']) == ['blue', 'red', 'green']
assert sol.either(Color.red, Color(0), ['green', 'green', 'red', 'green', 'green']) == ['red']
