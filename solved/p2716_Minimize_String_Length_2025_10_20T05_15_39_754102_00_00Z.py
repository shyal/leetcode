"""
URL: https://leetcode.com/problems/minimize-string-length/description/?envType=problem-list-v2&envId=vn57k9wr
...
assert sol.minimizedStringLength(s="aaabc") == 3
assert sol.minimizedStringLength(s="cbbd") == 3
assert sol.minimizedStringLength(s="baadccab") == 4
