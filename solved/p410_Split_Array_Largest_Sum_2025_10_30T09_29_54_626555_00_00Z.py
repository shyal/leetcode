...
class Solution:
    ...
    def can_split(self, nums, max_sum, m):
        ...
        for n in sorted(nums, reverse=True):
            prefix += n
            smaller_subs = self.count_smaller_subarrays(
                nums,
            )
...
# print(sol.count_smaller_subarrays([7, 2, 5, 10, 8], 18))
# print(sol.count_smaller_subarrays([7, 2, 5, 10, 8], 19))
# print(sol.count_smaller_subarrays([7, 2, 5, 10, 8], 17))
# # print(sol.can_split([7, 2, 5, 10, 8], 18, 2))
