"""
URL: https://leetcode.com/problems/minimum-average-of-smallest-and-largest-elements/description/?envType=problem-list-v2&envId=vn57k9wr
...
assert sol.minimumAverage(nums=[7, 8, 3, 4, 15, 13, 4, 1]) == 5.5
