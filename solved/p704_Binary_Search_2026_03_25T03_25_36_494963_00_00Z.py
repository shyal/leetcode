...
assert sol.search([-10000,10000], -10000) == 0
assert sol.search([-10000,10000], 10000) == 1
assert sol.search([-10000,10000], 0) == -1
assert sol.search([1], 1) == 0
assert sol.search([1,3], 3) == 1
assert sol.search([1,3,5], 5) == 2
assert sol.search([1,3,5,7], 7) == 3
assert sol.search([2,4,6,8,10], 2) == 0
assert sol.search([2,4,6,8,10], 10) == 4
assert sol.search([2,4,6,8,10], 6) == 2
assert sol.search([2,4,6,8,10], 1) == -1
assert sol.search([2,4,6,8,10], 11) == -1