...
assert sol.gcdOfOddEvenSums(6) == 6
assert sol.gcdOfOddEvenSums(7) == 7
assert sol.gcdOfOddEvenSums(12) == 12
assert sol.gcdOfOddEvenSums(100) == 100
assert sol.gcdOfOddEvenSums(999) == 999
assert sol.gcdOfOddEvenSums(1000) == 1000
assert all(sol.gcdOfOddEvenSums(n) == n for n in range(1, 1001))