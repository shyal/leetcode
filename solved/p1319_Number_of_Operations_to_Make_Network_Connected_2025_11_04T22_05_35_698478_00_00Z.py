...
assert sol.makeConnected(4, edges) == 1
edges = [[0, 1], [0, 2], [0, 3], [1, 2], [1, 3]]
draw_graphviz(edges, n=6)
assert sol.makeConnected(6, edges) == 2
edges = []
draw_graphviz(edges, n=1)
assert sol.makeConnected(1, edges) == 0
edges = [[0, 1]]
draw_graphviz(edges, n=2)
assert sol.makeConnected(2, edges) == 0
edges = [[0, 1], [0, 2]]
draw_graphviz(edges, n=3)
assert sol.makeConnected(3, edges) == 0
edges = [[0, 1], [1, 2], [0, 2]]
draw_graphviz(edges, n=3)
assert sol.makeConnected(3, edges) == 0
edges = [[0, 1], [0, 2], [0, 3], [0, 4]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == 0
edges = [[0, 1], [0, 2], [1, 2], [3, 4]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == 1
edges = [[0, 1], [0, 2], [0, 3], [1, 2], [1, 3], [2, 3]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == 1
edges = [[0, 1], [0, 2], [0, 3], [1, 2], [1, 3], [4, 5], [4, 6]]
draw_graphviz(edges, n=7)
assert sol.makeConnected(7, edges) == 1
edges = [[1, 2], [1, 3], [1, 4], [2, 3]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == 1
edges = [[0, 1], [0, 2], [0, 3], [1, 2], [1, 3], [4, 5]]
draw_graphviz(edges, n=6)
assert sol.makeConnected(6, edges) == 1
edges = [[0, 1], [0, 3], [0, 4], [1, 3]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == 1
edges = []
draw_graphviz(edges, n=2)
assert sol.makeConnected(2, edges) == -1
edges = [[0, 1]]
draw_graphviz(edges, n=3)
assert sol.makeConnected(3, edges) == -1
edges = [[0, 1], [2, 3]]
draw_graphviz(edges, n=5)
assert sol.makeConnected(5, edges) == -1
edges = []
