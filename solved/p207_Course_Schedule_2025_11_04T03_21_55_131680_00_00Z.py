...
# print(sol.canFinish(5, [[1, 0], [2, 0], [3, 1], [3, 2], [4, 3]]))
...
assert sol.canFinish(3, [[1, 0], [0, 1]]) == False
assert sol.canFinish(3, [[0, 1], [1, 2], [2, 0]]) == False
assert sol.canFinish(4, [[0, 1], [1, 2], [2, 3]]) == True
assert sol.canFinish(4, [[0, 1], [1, 2], [2, 0], [3, 0]]) == False
assert sol.canFinish(5, [[1, 0], [2, 0], [3, 1], [3, 2], [4, 3]]) == True
assert sol.canFinish(2, []) == True
assert sol.canFinish(3, [[0, 1], [0, 2], [1, 2]]) == True
assert sol.canFinish(3, [[1, 0]]) == True
