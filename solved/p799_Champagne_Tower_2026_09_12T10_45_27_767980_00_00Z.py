...
This feels a bit like pascal's triangle for some reason,
...
That's the case where two glasses are poured. However it gets tricky. We pour another glass:
...
Then it gets even more complicated, because the middle glass pours unevenly.

     1
  1     1
.6   1    .6

So glasses with 2 glass above them fill twice as fast as those on the edges.

...


Asked for solution. Learning.
