...
assert sol.maxDepth("()()") == 1
assert sol.maxDepth("(())") == 2
assert sol.maxDepth("((()))") == 3
assert sol.maxDepth("(1)") == 1
assert sol.maxDepth("((1+2)*3)") == 2
assert sol.maxDepth("(1+(2+(3)))") == 3
assert sol.maxDepth("1+2-3*4/5") == 0
assert (
    sol.maxDepth(
        "((((((((((((((((((((((((((((((((((((((((((((((((((1))))))))))))))))))))))))))))))))))))))))))))))))))"
    )
...
assert sol.maxDepth("(((1+(2*3))+4))") == 4
assert sol.maxDepth("(1+(2*3)+((8)/4))+1+(9*(7/5))") == 3
assert sol.maxDepth("((((1))))") == 4
assert sol.maxDepth("()(()())") == 2
assert sol.maxDepth("(((())))") == 4
assert sol.maxDepth("1*(2/(3+4))") == 2
assert sol.maxDepth("(())+(())") == 2
