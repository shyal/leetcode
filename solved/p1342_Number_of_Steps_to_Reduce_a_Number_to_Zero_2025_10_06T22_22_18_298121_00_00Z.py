"""
URL: https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/description/?envType=study-plan-v2&envId=leetcode-75
...
assert sol.numberOfSteps(4) == 3
assert sol.numberOfSteps(1000000) == 26
