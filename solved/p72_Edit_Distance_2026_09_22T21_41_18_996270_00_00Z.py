# combo chain: two-sequence-align, problem 5 of 14. Run `make combos two-sequence-align` to see
...
LEETCODE: Accepted (51 ms, 29.2 MB)
"""
...
# assert sol.minDistance("abcde" * 100, "edcba" * 100) == 400
