...
#
# def query() -> str
#   'select project_id, round(avg(experience_years), 2) as average_years from Project group by project_id;'

class Solution(SQLDrill):
    def query(self) -> str:
        return 'select project_id, round(avg(experience_years), 2) as average_years from Project group by project_id;'
