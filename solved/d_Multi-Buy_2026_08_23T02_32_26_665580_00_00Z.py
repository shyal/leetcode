...
Got a bit confused between 'term' 'atom' and 'expr'. Wrote atom correctly
but the loop never ended. I forgot self.i += 1 after getting the op.

So i added self.next to the Parser class, which makes term even shorter and
cleaner.
