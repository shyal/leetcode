"""
URL: https://leetcode.com/problems/find-the-array-concatenation-value/description/?envType=problem-list-v2&envId=vn57k9wr
...
class Solution:
    ...
    def findTheArrayConcVal(self, nums: List[int]) -> int:
        ...
        concatVal = 0
        while len(nums) > 1:
            concatVal += self.concatAdd(nums.popleft(), nums.pop())
        return concatVal + next(iter(nums), 0)
...
assert sol.findTheArrayConcVal([1]) == 1
assert sol.findTheArrayConcVal([1, 2]) == 12
assert sol.findTheArrayConcVal([1, 2, 3]) == 15
assert sol.findTheArrayConcVal([10000, 9999]) == 100009999
assert sol.findTheArrayConcVal([1, 1, 1]) == 12
assert sol.findTheArrayConcVal([10, 1, 10]) == 1011
assert sol.findTheArrayConcVal([1, 10000, 1]) == 10011
assert sol.findTheArrayConcVal([9, 10]) == 910
assert sol.findTheArrayConcVal([99, 1]) == 991
