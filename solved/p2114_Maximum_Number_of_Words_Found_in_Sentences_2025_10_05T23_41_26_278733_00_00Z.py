...
assert sol.mostWordsFound(["a"]) == 1
assert sol.mostWordsFound(["singleword"]) == 1
assert sol.mostWordsFound(["a b c d e f g h i j"]) == 10
assert sol.mostWordsFound(["one", "two words", "three words here"]) == 3
assert sol.mostWordsFound(["a " * 49 + "a"]) == 50
assert sol.mostWordsFound(["a", "b", "c"]) == 1
assert sol.mostWordsFound(["hello world", "python is fun"]) == 3
