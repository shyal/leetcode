...
assert get_list_values(
    sol.deleteDuplicates(build_linked_list([1, 2, 3, 3, 4, 4, 5]))
) == [1, 2, 5]
assert get_list_values(sol.deleteDuplicates(build_linked_list([1, 1, 1, 2, 3]))) == [
    2,
    3,
]
...
assert get_list_values(
    sol.deleteDuplicates(build_linked_list([1, 1, 2, 2, 3, 3, 4]))
) == [4]
assert get_list_values(sol.deleteDuplicates(build_linked_list([1, 2, 2]))) == [1]
assert get_list_values(sol.deleteDuplicates(build_linked_list([-1, -1, 0, 1, 1]))) == [
    0
]
assert get_list_values(sol.deleteDuplicates(build_linked_list([0, 0, 0]))) == []
assert get_list_values(sol.deleteDuplicates(build_linked_list([-100, -100, 100]))) == [
    100
]
assert get_list_values(
    sol.deleteDuplicates(build_linked_list([1, 2, 3, 4, 4, 5, 6]))
) == [1, 2, 3, 5, 6]
