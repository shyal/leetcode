"""
URL: https://leetcode.com/problems/kth-largest-element-in-a-stream/description/?envType=problem-list-v2&envId=vn57k9wr
...
assert kth_largest.add(-10000) == -10000
assert kth_largest.add(10000) == 10000
assert kth_largest.add(5) == 10000
...
kth_largest = KthLargest(1, [-3, -2, -1])
assert kth_largest.add(-5) == -1
assert kth_largest.add(0) == 0
assert kth_largest.add(-10) == 0

kth_largest = KthLargest(3, [5, 5, 5, 5])
assert kth_largest.add(5) == 5
assert kth_largest.add(4) == 5
assert kth_largest.add(6) == 5
assert kth_largest.add(6) == 5
assert kth_largest.add(6) == 6

kth_largest = KthLargest(3, [1, 2])
assert kth_largest.add(10) == 1
assert kth_largest.add(0) == 1
assert kth_largest.add(5) == 2

kth_largest = KthLargest(2, [-10000, 10000])
assert kth_largest.add(10000) == 10000
assert kth_largest.add(-10000) == 10000

kth_largest = KthLargest(4, [3, 1, 2, 4])
assert kth_largest.add(0) == 1
