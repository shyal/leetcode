...
assert sol.divisorGame(2) is True
assert sol.divisorGame(3) is False
...
assert sol.divisorGame(0) == True
assert sol.divisorGame(998) == True
assert sol.divisorGame(997) == False
assert sol.divisorGame(500) == True
assert sol.divisorGame(501) == False
